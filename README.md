...
**nogadamachine 제작** / **3.0.0-dev.5 개발판** / **KakaoTalk 26.7.3 전용**
...
3.0.0-dev.5는 삭제 전에 보관한 텍스트를 원래 말풍선에 표시하고, 메시지마다 빨간 **삭제됨**을 붙입니다. 아이폰에서 받은 메시지와 보낸 메시지의 실제 삭제, 같은 시각으로 묶인 메시지, 옵션 끄기와 재실행을 확인했습니다. 삭제 전에 원문을 보관하지 못한 메시지나 사진과 영상은 복원하지 않습니다.
