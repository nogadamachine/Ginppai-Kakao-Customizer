...
**nogadamachine 제작** / **3.0.2 정식판** / **KakaoTalk 26.7.3 전용**
...
**카카오톡 26.8.0은 아직 지원 검증 전입니다.** 현재 배포본의 검증 대상은 26.7.3입니다.
...
3.0.2은 **KakaoTalk 26.7.3 / iOS 26.1 / SideStore + LiveContainer**에서 확인한 정식 배포본입니다. 삭제된 텍스트 표시, 메시지 도구, 변경 기록 검색과 설정 복원을 실기에서 검사했습니다. 보관함은 수정 전 원문을 포함한 모든 기록을 검색하고 최근 500개 결과를 표시합니다. 로컬 회귀 검증 188건과 배포 파일의 서명, 구조, 해시 검사를 통과했습니다.
