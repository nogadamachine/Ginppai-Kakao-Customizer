...
참조 버전 v1.5.0-dev.9, 커밋 `70f43985acdb0f9fe49d5cda0b88676583aca2d1`. 출처와 기여자 고지는 [NOTICE.md](../NOTICE.md)에 있습니다. 원래 Android 대상은 26.7.2이며 iOS 대상은 26.7.3과 26.8.0입니다. 아래 영문 이름과 번호는 소스 대조용 식별자로, 설정 화면의 메뉴 이름과 다릅니다.
