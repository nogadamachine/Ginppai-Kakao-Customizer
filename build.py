...
subprocess.run(['xcrun', 'swiftc', *target, '-O', '-parse-as-library', '-emit-object',
                '-module-name', 'KCMedia', str(ROOT/'src/MediaResolver.swift'), '-o', str(BUILD/'MediaResolver.o')], check=True, env=ENV)
